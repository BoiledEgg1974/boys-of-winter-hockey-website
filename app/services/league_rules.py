...
DEFAULT_LEAGUE_RULES: tuple[dict[str, str], ...] = (
    ...
    {"rule_key": "bowl_six_lock_time_et", "rule_value": "19:59"},
    # Comma-separated site user ids excluded from BOWL Six (submissions, leaders, lineups).
    {"rule_key": "bowl_six_excluded_user_ids", "rule_value": ""},
)
