...
hall_of_fame.csv (optional, per league folder)
  Re-import upserts rows into hall_of_fame_members (additive; never deletes existing inductees).
  Admin-sourced rows are never overwritten by CSV. Use Admin → Hall of Fame to remove a player.
