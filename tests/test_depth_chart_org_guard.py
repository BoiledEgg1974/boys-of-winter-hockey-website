...
from app.config import LEAGUES, league_by_slug, make_league_config
...
def _depth_guard_leagues():
    """During ``import_data.py``, only check the league being imported (``LEAGUE_SLUG``)."""
