...
class TradeMarketAllLeaguesTest(unittest.TestCase):
    ...
    def test_trade_market_template_uses_card_layout_and_shared_rating_classes(self) -> None:
        ...
        self.assertIn("trade-market-team-block__logo", text)
        self.assertIn("--trade-team-color", text)
        self.assertIn("max-height: 35rem", text)
        ...
        self.assertIn("trade_market_rating('POT'", text)
        self.assertIn("Age {{ row.age }}", text)
        self.assertNotIn("trade_market_rating('AGI'", text)
    ...
    def test_trade_market_public_route_hides_guest_gm_details(self) -> None:
        ...
        self.assertIn("team_logo_url_for_team(team)", route_text)
        self.assertIn("team.primary_color", route_text)
