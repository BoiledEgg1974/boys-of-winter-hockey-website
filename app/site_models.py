...
class BoostLotteryTeamResult(db.Model):
    ...
    __tablename__ = "boost_lottery_team_results"
    __bind_key__ = "site"
    __table_args__ = (
        UniqueConstraint("league_slug", "team_id", name="uq_boost_lottery_team_league_team"),
        Index("ix_boost_lottery_team_league", "league_slug", "team_id"),
    )
...
class TeamCapPenalty(db.Model):
    """Manual FHM-style cap hit penalties per team/season (site DB; not in CSV exports)."""

    __tablename__ = "team_cap_penalties"
    __bind_key__ = "site"
    __table_args__ = (
        UniqueConstraint(
            "league_slug",
            "season_start_year",
            "team_id",
            name="uq_team_cap_penalty_league_season_team",
        ),
        Index("ix_team_cap_penalty_league_season", "league_slug", "season_start_year"),
    )
