...
from app.site_models import AdminAuditLog, BowlSixLineup, BowlSixSlate, User
...
def register_bowl_six_routes(gm_bp: Blueprint, admin_bp: Blueprint) -> None:
    @gm_bp.get("/bowl-six")
    @login_required
    def bowl_six_hub():
    ...
    @gm_bp.route("/bowl-six/lineup", methods=["GET", "POST"])
    @login_required
    def bowl_six_lineup():
        _require_bowl_six_access()
        slug = _league_slug()
    ...
    @gm_bp.get("/bowl-six/api/players")
    @login_required
    ...
    @admin_bp.post("/control-center/bowl-six/score")
    @login_required
    ...
    @admin_bp.post("/control-center/bowl-six/rescore")
    @login_required
    ...
    @admin_bp.post("/control-center/bowl-six/unlock")
    @login_required
    ...
    @admin_bp.post("/control-center/bowl-six/extend-lock")
    @login_required
    ...
    @admin_bp.post("/control-center/bowl-six/skip-week")
    @login_required
    ...
    @admin_bp.post("/control-center/bowl-six/advance-week")
    @login_required
