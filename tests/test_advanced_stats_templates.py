...
class AdvancedStatsTemplatesTest(unittest.TestCase):
    ...
    def test_advanced_stats_route_includes_lines_tab(self) -> None:
        ...
        self.assertIn("build_team_shot_quality_payload_from_archive", main)
        self.assertIn("team_shot_quality_season_options", main)
        ...
        self.assertIn('name="sq_season"', team_sq)
        self.assertIn("team_shot_quality_selected_key", team_sq)
        self.assertIn("seasonAxisDefaults", js)
        self.assertIn("axis_defaults", js)
        ...
        self.assertIn("data-team-stats-trend-archive-note", team_template)
        ...
        self.assertIn("data-team-stats-trend-archive-note", js)
